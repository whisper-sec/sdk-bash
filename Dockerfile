...
# Setup prompt
#
RUN echo 'export PS1="[Whisper API Platform] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Whisper API Platform] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Whisper API Platform$(tput sgr0).\n\
\n\
